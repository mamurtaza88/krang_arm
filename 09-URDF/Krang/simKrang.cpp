...
SkeletonPtr createKrang()
{
  ...
  SkeletonPtr krang =
      loader.parseSkeleton("/usr/local/share/krang/urdf/Krang/Krang.urdf");
  krang->setName("krang");
  ...
  // Test to print out DampingCoefficient
  std::cout << "DampingCoeffLW:" << krang->getJoint("JLWheel")->getDampingCoefficient(0);
  std::cout << "DampingCoeffRW:" << krang->getJoint("JRWheel")->getDampingCoefficient(0);
